...
import com.velvra.backend.security.CustomUserDetailsService;
import com.velvra.backend.security.JwtAuthFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/posts/creator/**").permitAll()
